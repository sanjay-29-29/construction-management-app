...
# This script should be run once before starting your docker compose stack

# Replace these with your actual values
domains=(ksconstruction.online www.ksconstruction.online)
email="sanjaysusi29@gmail.com" # Adding a valid email is strongly recommended
