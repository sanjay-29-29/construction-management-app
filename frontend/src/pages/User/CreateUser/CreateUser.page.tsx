...
export const CreateUserPage = () => {
  ...
  return (
    <Scaffold title="Create User" disablePadding>
      <div className="p-4 pb-20 bg-white flex-1 lg:m-8 lg:rounded-md lg:flex-initial lg:p-4">
        <Form {...form}>
          <form className="grid gap-5" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Enter password for the user</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <div className="fixed bottom-0 inset-x-0 bg-white/90 backdrop-blur border-t px-4 py-3 lg:static lg:mt-6 lg:flex lg:justify-end lg:bg-transparent lg:border-none lg:p-0">
              <Button
                className="w-full h-12 text-base font-medium lg:w-auto lg:h-10"
                disabled={mutation.isPending}
              >
                {mutation.isPending ? (
                  <>
